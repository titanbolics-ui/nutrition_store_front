const SkeletonCartTotals = ({ header = true }) => {
  return (
    <div className="flex flex-col">
      {header && <div className="w-32 h-4 bg-gray-800 mb-4 rounded animate-pulse"></div>}
      ...
      <div className="w-full border-b border-gray-700 border-dashed my-4"></div>

      <div className="flex items-center justify-between">
        <div className="w-32 h-6 bg-gray-800 mb-4 rounded animate-pulse"></div>
        <div className="w-24 h-6 bg-gray-800 mb-4 rounded animate-pulse"></div>
      </div>
    </div>
  )
}
