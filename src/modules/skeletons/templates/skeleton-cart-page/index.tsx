    ...
    <div className="py-12 bg-[#0a0a0a] min-h-screen">
      <div className="content-container">
        <div className="grid grid-cols-1 small:grid-cols-[1fr_360px] gap-x-40">
          <div className="flex flex-col bg-[#111111] p-6 gap-y-6 rounded-lg">
            <div className="bg-[#111111] flex items-start justify-between">
            ...
            <div>
              <div className="pb-3 flex items-center">
                <div className="w-20 h-12 bg-gray-800 animate-pulse rounded" />
              </div>
              <Table>
                <Table.Header className="border-t-0 border-gray-800">
                  <Table.Row className="border-gray-800">
                    <Table.HeaderCell className="!pl-0">
                      <div className="w-10 h-6 bg-gray-800 animate-pulse rounded" />
                    </Table.HeaderCell>
                    ...
                    <Table.HeaderCell>
                      <div className="w-12 h-6 bg-gray-800 animate-pulse rounded" />
                    </Table.HeaderCell>
